...
namespace OSCA
{
    ...
    public static class Algorithms
    {
        ...
        /// The algorithms
        /// </summary>
        public static readonly Dictionary<string, DerObjectIdentifier> algorithms = new Dictionary<string,DerObjectIdentifier>();
        /// <summary>
        /// The ex parameters
        /// </summary>
        public static readonly Dictionary<string, RsassaPssParameters> exParams = new Dictionary<string,RsassaPssParameters>();
        /// <summary>
        /// The key algorithms
        /// </summary>
        public static readonly Dictionary<DerObjectIdentifier, string> keyAlgorithms = new Dictionary<DerObjectIdentifier,string>();
        /// <summary>
        /// The oids
        /// </summary>
        public static readonly Dictionary<DerObjectIdentifier, string> oids = new Dictionary<DerObjectIdentifier,string>();
        /// <summary>
        /// The no parameters
        /// </summary>
		public static readonly List<DerObjectIdentifier> noParams = new List<DerObjectIdentifier>();
